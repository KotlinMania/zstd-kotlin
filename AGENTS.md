...
This file is the quick-reference operating contract for zstd-kotlin. The longer
...
zstd-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`zstd`](https://crates.io/crates/zstd). Upstream Rust is the behavioral oracle while the
