...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Zstd.swiftmodule/`
...
//      `import Zstd` above would fail at compile time.
//
//   2. The static archive `libZstd.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Zstd" }` and
//      `flattenPackage = "io.github.kotlinmania.zstd"` configuration in
